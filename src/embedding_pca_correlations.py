...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=[paths.ECM_EUROPE_CSV, paths.ECM_ASIA_CSV],
        help="Paths to the biodiversity CSV files containing sample metadata."
    )
    parser.add_argument(
        '--representations_dir', type=str, default=paths.REPRESENTATIONS_DIR,
        help="Directory containing the SSL .npy representation files."
    )
    parser.add_argument(
        '--soil_cache_dir', type=str, default=paths.SOIL_CACHE_DIR,
        help="Directory containing cached SoilGrids features."
    )
    parser.add_argument(
        '--climate_cache_dir', type=str, default=paths.CLIMATE_CACHE_DIR,
